    ...
    return <Modal transparent={true} animationType={"slide"} visible={isShow} onRequestClose={onClose} >
        <View style={[styles.botton_view, { backgroundColor: 'rgba(0, 0,0, .7 )', justifyContent: "flex-end" }]}>
            <View style={{
                ...
                backgroundColor: colors.white, borderTopLeftRadius: 13, borderTopRightRadius: 13,
                width: "100%", flex: 0.8
            }}>
                            ...
                            <View style={{ flexDirection: 'row', paddingVertical: 16 }}>
                                ...
                                <Text
                                    style={[
                                        styles.textStyle,
                                        {
                                            fontSize: 14, color: colors.blacl5B5B5B,
                                            flex: 0.5
                                        },
                                    ]}
                                >
...
const CommonButton = ({ text = AppString.ok, endColor = colors.endOrange,
    startorange = colors.startOrange, onClick }) => {

    return (
        <TouchableOpacity onPress={onClick} style={{ position: 'absolute', width: '100%', start: 16, bottom: 10 }}>
            <LinearGradient
