...
export const ViewMobileNumberScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={[styles.container, { padding: 0, backgroundColor: colors.white }]}>
      <CustomHeader navigation={navigation} title={isMobile ? RouteNames.viewPhoneNumber : AppString.mail} />

      <ScrollView
        contentContainerStyle={{ flex: 1 }}
        showsVerticalScrollIndicator={false}>
        <View style={[styles.container, { backgroundColor: colors.white, paddingTop: 6 }]}>
          <Text
            style={[
              styles.textStyle,
