...
const categories = ["Women's", "Men's", "Baby", "Home", "美妆", "电器", "家具", "玩具", "配饰", "内衣", "鞋靴", "汽车用品"]
const products = [{ title: "coat", isSelected: false }, { title: "3 category", isSelected: false },
{ title: "Jacket", isSelected: false }, { title: "Cotton clothes", isSelected: false }, { title: "down jacket", isSelected: false },
{ title: "leather coat", isSelected: false },
{ title: "棒球服", isSelected: false }, { title: "西装", isSelected: false }, { title: "PU皮衣", isSelected: false },
]
...
export const AllCategoriesScreen = ({ navigation }) => {
    ...
    return <View style={[styles.container, { paddingEnd: 6 }]}>
        <View style={[styles.container, { flexDirection: 'row', padding: undefined, marginTop: -10 }]}>
            <FlatList
            ...
            <FlatList
                style={{ width: '78%' }}
                data={[{ title: "Jackets", product: products }, { title: "Tops", product: products }
                    , { title: "Joggers", product: products }]}
                showsVerticalScrollIndicator={false}
                renderItem={({ item, index }) =>
                    <View style={{
                        backgroundColor: colors.white, marginTop: 9,
                        paddingBottom: 9.5,
                        borderRadius: 11
                    }}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) =>
                                ...
                                >
                                    ...
                                    <Text style={[styles.textStyle, {
                                        fontSize: 13,
                                        color: colors.balc111111, marginTop: 2.5,
                                    }]}>
                                        {item.title}
                                    </Text>
...
const TextWithIcon = ({ title = "Jackets", padding = 10, onClick }) => {
    ...
    return (
        <TouchableOpacity
            ...
            style={[
                styles.profile,
                { marginTop: undefined, alignItems: "center", paddingTop: 10, paddingHorizontal: 20 },
            ]}
        >
            <Text
                style={[
                    styles.textStyle,
                    { fontSize: 15, fontWeight: "500", fontFamily: undefined, color: colors.black222222 },
                ]}
            >
                {title}
            </Text>
