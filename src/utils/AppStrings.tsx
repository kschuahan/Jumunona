export const AppString = {
  ...
  sure: 'Уверены?',
  recovery_after_cleaning_is_not_posible:
    'Восстановление после очистки невозможно',
  yes: 'Да',
  no: 'Нет',
  similar: 'Похожее',
  ...
  your_review_help_others_make_a_choice:
    'Ваш отзыв помогает другим сделать выбор',
  rating: 'Рейтинг',
  great: 'Отличный',
  quality: 'Качество',
