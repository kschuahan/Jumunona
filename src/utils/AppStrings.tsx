export const AppString = {
  ...
  alert: 'Тревога',
  views: '+ просмотров',
  check_your_internet_connection: 'Пожалуйста, проверьте подключение к Интернету и повторите попытку.',
  something_is_wrong: 'Что-то пошло не так. Пожалуйста, попробуйте еще раз',
